...
<body>
	<div class="container mt-3">
		...
		<form
			action="${pageContext.request.contextPath}/partyBoard/partyBoard-modify"
			...
			<div class="row">
				...
				<div class="mb-3 mt-3 col p-3">
					<label for="title">제목:</label> <input type="text"
						...
						placeholder="제목을 입력해주세요" value="${partyBoard.title}">
				</div>
				<div class="mb-3 mt-3 col p-3">
					<label for="id">작성자:</label>
					<div class="form-control" id="id">${requestScope.partyBoardVO.user_id == null ? SPRING_SECURITY_CONTEXT.authentication.principal.userVO.id : requestScope.partyBoardVO.user_id}</div>
				</div>
			</div>
			<div>
				<table>
					<tr>
						<td colspan="2"><label for="max_people">최대 모집 인원</label></td>
					</tr>
					<tr>
						<td valgn="top"><select name="max_people">								
			...
			<div class="mb-3 mt-3">
				...
				<textarea class="form-control" id="contents" name="contents"
					rows="5" placeholder="내용을 입력해주세요">${partyBoard.contents}</textarea>
			</div>
			<div class="row">
				<div class="col p-3">
					<a href="${pageContext.request.contextPath}/menu/partyBoard?user_id=${SPRING_SECURITY_CONTEXT.authentication.principal.userVO.id}">
						<button id="back" type="button"
							class="get col p-3 btn btn-primary">파티모집게시판 목록</button>				
					</a>
				</div>
				<div class="col p-3">
