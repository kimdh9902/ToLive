...
<script>
	...
	function goMain(){
		location.href="${pageContext.request.contextPath}/menu/travBoard";
	}
						...
						<div class="board_header">
							...
							<div class="WriterInfo">
								<div class="thumb_area">
									<a href="${pageContext.request.contextPath}/menu/profile?user_id=${TravBoardVO.user_id}" class="thumb">
										<img class="img-xs rounded-circle" src="${pageContext.request.contextPath}/resources/TripToLive/default/default.jpg" alt="no">			
									</a>	
								</div>								
							...
							<div class="total_emoji">
								공감수  ${TravBoardVO.total_emoji}
							</div>
						</div>
						<!-- header 끝 -->
