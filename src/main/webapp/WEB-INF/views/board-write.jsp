      ...
      <form action="${pageContext.request.contextPath}/travBoard/board-insert" method="post">
         ...
         <div class="row">
            ...
            <a href="${pageContext.request.contextPath}/menu/travBoard">
               <button id="back" type="button" class="get col p-3 btn btn-primary">여행후기글 목록</button><!-- onclick="goMain();" -->
            </a>
            </div>
            <div class="col p-3">
            ...
            <div class="col p-3">
            <button id="sub" type="submit" class="register col p-3 btn btn-primary">등록하기</button>
            </div>
         </div>
