							...
							<div class="row">
								<div class="col-12 grid-margin">
									<div class="card">
										<div class="card-body">
											<div class="container">
												<h2 class="text-center mb-4">파티 모집 게시판 신고 페이지</h2>
												<!-- report page contents -->
												<div class="container" style="border: 10px double white; padding: 30px">
													  <!-- form start -->
													  <form id="myForm" action="${pageContext.request.contextPath}/partyBoard/report-processing" method="post">
														<div class="box-container">
															<div class="box">
																<h3 class="text-center mb-4">게시글</h3>
																<div class="mb-3">
																	<label for="b_no" class="form-label">게시글 번호</label>
																	<input type="text" class="form-control" id="b_no" name="b_no" value="${partyBoard.b_no}" readonly>
																</div>
																<div class="mb-3">
																	<label for="title" class="form-label">제목</label>
																	<input type="text" class="form-control" id="title" name="title" value="${partyBoard.title}" readonly>
																</div>															
															</div>
															<div class="box">
