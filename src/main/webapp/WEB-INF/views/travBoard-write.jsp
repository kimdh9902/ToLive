...
<body>
   <div class="container">
      ...
      <form action="${pageContext.request.contextPath}/travBoard/travBoard-insert" method="post" >
         <div class="row">
         ...
         <div class="row">
            <div class="col p-3">
               <a href="${pageContext.request.contextPath}/menu/travBoard?user_id=${SPRING_SECURITY_CONTEXT.authentication.principal.userVO.id}">
                  <button id="back" type="button"
                     class="custom-btn">여행후기글 목록</button> 
               </a>
            </div>
            ...
            <div class="col p-3">
               <button id="sub" type="submit"
                  class="custom-btn" onclick="return goSubmit()">등록하기</button>
            </div>
         </div>
